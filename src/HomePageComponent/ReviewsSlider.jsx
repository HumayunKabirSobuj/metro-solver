...
const ReviewsSlider = () => {
  ...
  return (
    <div>
      {" "}
      <div className="pb-20 mt-20 lg:flex hidden">
        <Swiper
          spaceBetween={30}
          centeredSlides={true}
          autoplay={{
                ...
                <div className="flex flex-col items-center justify-start text-left">
                  <div className="p-16">
                    ...
                    <p className="text-white text-[32px mb-6">
                      “Metro Solver with Mixer was the best solution. <br /> I
                      am very satisfied with the team and the work <br /> they
                      did. I am sincerely grateful for the work <br /> and
                      effort.”
                    </p>
      ...
      <div className="pb-20 mt-20 flex lg:hidden">
        <Swiper
          spaceBetween={30}
          centeredSlides={true}
          autoplay={{
        ...
        >
          <SwiperSlide>
            <div>
              <div className="flex rounded-3xl max-w-[1000px] mx-auto shadow-lg">
                {/* Left Side: Review Content */}
                <div className="flex-1 text-left justify-start ">
                  {/* Quote Icon */}
                  <div className="text-[#22dde4ce] text-5xl">
                    <RiDoubleQuotesL />
                  </div>
                  ...
                  <div className="mt-6 flex  flex-col   gap-2 ">
                    ...
                    <p className="text-[#E7E8EA] text-[12px]">
                      Founder of Strava
                    </p>
                  </div>
                  ...
                  {/* Star Rating */}
                  <div className="flex mt-4 space-x-1 text-xl text-orange-400">
                ...
                <div className="flex-1 flex items-center justify-center">
                  <img
                    src={reviewsPerson}
                    alt="Reviewer"
                    className="rounded-3xl object-cover h-[160px] w-[150px]"
                  />
                </div>
              </div>
              <div>
              <p className="text-white text-[16px] text-left p-3">
                      “Metro Solver with Mixer was the best solution.  I
                      am very satisfied with the team and the work  they
                      did. I am sincerely grateful for the work  and
                      effort.”
                    </p>
              </div>
            </div>
